<x-guest-layout>
    <h2 class="text-2xl font-bold text-slate-800 mb-1">إنشاء حساب جديد ✨</h2>
    <p class="text-slate-600 text-sm mb-6">أنشئ حسابك للبدء في إدارة العقود</p>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="mb-4">
            <label for="name" class="block text-sm font-semibold text-slate-700 mb-2">الاسم الكامل</label>
