                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2">
                                ...
                                @can('delete', $contract)
                                <form method="POST" action="{{ route('contracts.destroy', $contract) }}" onsubmit="return confirm('هل أنت متأكد من حذف هذا العقد نهائياً؟')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-rose btn-sm" title="حذف العقد">
